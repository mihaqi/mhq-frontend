        ...
        <div className="flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-[100px]">
          ...
          <div className="flex-[1] py-3">
            ...
            <div className="grid grid-cols-3 gap-2 py-8">
              ...
              <button className="btn border py-4 text-lg text-white bg-green-500 rounded-md" onClick={() => router.push(`https://wa.me/212${whatsapp}?text=${product.title}`)}>whatsapp</button>
            </div>
            {/* Size End */}
          </div>
          {/* right colum end*/}
